...
\begin{frame}{Message Passing: Message $\to$ Aggregate $\to$ Update}
  ...
  \begin{tikzpicture}[scale=0.9, transform shape]
    ...
    \visible<2->{
      \node[font=\small, text=VUgrey, anchor=south] at (9.9,2.3) {\textbf{what node $v$ holds}};
    ...
    \visible<4->{
      ...
      \node[font=\small, text=VUgrey, anchor=east, text width=2.9cm, align=right] at (10.2,-1.15)
