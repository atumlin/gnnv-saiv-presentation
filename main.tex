  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.42\textwidth}
      ...
      \begin{tikzpicture}[scale=0.9]
        ...
        \foreach \a in {30,150,270} \node[circle,fill=steelblue!35,draw=VUgrey,minimum size=4mm,inner sep=0pt] at (\a:0.85) {};
        \foreach \a in {90,210,330} \node[circle,fill=VUgrey!15,draw=VUgrey,minimum size=3.4mm,inner sep=0pt] at (\a:1.65) {};
        \node[circle,fill=VUgold!55,draw=VUblack,thick,minimum size=5mm,inner sep=0pt,font=\scriptsize\bfseries] at (0,0) {$v$};
        \node[font=\tiny, text=VUgoldDark] at (0,1.28) {$K$-hop};
      \end{tikzpicture}
    \end{column}
  \end{columns}
\end{frame}
