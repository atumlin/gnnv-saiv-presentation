...
\tikzset{
  ...
  slbl/.style={font=\fontsize{6.4}{7.6}\selectfont, text=VUgrey},
  ...
  \begin{tikzpicture}[scale=0.92, transform shape]
    ...
    \visible<2->{
      ...
      \node[slbl, anchor=north west, text width=3.4cm] at (3.4,1.1)
        {\textcolor{VUgoldDark}{\textbf{1. Message:}} each neighbour sends its
         features, mixed with \textcolor{VUgoldDark}{edge feature} $e_{uv}$.};
    }
    % ================= (c) aggregate =================
    \visible<3->{
    ...
    \visible<4->{
      ...
      \node[slbl, anchor=north west, text width=3.4cm] at (3.4,-2.7)
        {\textbf{\comb{3. Update}} (a.k.a.\ combine): a learned map, then
         ReLU.};
    }
    ...
    \visible<3->{
      ...
      \node[font=\scriptsize, text=VUgrey, anchor=north] at (11.09,0.5) {$z_v$};
    }
    \visible<4->{
      \node[font=\large, text=combcol] at (10.45,-1.15) {$\Downarrow$};
      \foreach \i in {0,...,3} {\node[vec=combcol!40] at (11.0, -1.55+\i*0.24) {};}
      \node[font=\scriptsize, text=VUgrey, anchor=north] at (11.14,-1.62) {$h_v^{(\ell+1)}$};
